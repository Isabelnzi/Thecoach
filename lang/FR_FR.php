...
define('REGISTER_SPORTS','');
define('REGISTER_HOUR','');
define('REGISTER_PROPOSITION','Description');
...
define('ERROR_EMAIL','Erreur dans la saisie de l\'adresse mail');
define('ERROR_ADDRESS','Erreur dans la saisie de l\'adresse');
define('ERROR_CITY','Erreur dans le nom de la ville');
define('ERROR_PHONENUMBER','Numéro de téléphone :');
...
define('NAV_EVENT','Proposer une activité');
