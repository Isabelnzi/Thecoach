...
if (isset($_POST['registerCoach']) && (count($formError) === 0)) {
    ?> 
    <div class="alert" id="Coachregister">
            ...
            <div class="form-group has-error">
                <div class="card">
                    ...
                    <div class="col">
                        ...
                        <!-- Sign up button -->
                        <div>
                            <input type="submit" value="<?= REGISTER_SUBMIT ?>" name="registerCoach"/>
                        </div>
                    </div>
                </div>
            </div>
